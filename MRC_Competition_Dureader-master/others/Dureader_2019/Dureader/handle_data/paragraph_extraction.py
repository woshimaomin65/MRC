...
if __name__ == "__main__":
    ...
    mode = sys.argv[1]
    if mode == 'searchtest':
        f = open('/Users/maomin/programs/dureader_data/preprocessed/testset/search.test.json')
        fw = open('/Users/maomin/programs/MRC_Competition_Dureader-master/others/Dureader_2019/Dureader/data/extracted/testset/search.test.json','w')
    elif mode == 'zhidaotest':
        f = open('/Users/maomin/programs/dureader_data/preprocessed/testset/zhidao.test.json')
        fw = open('/Users/maomin/programs/MRC_Competition_Dureader-master/others/Dureader_2019/Dureader/data/extracted/testset/zhidao.test.json','w')
    elif mode == 'searchtrain':
        f = open('/Users/maomin/programs/dureader_data/preprocessed/trainset/search.train.json')
        fw = open('/Users/maomin/programs/MRC_Competition_Dureader-master/others/Dureader_2019/Dureader/data/extracted/trainset/search.train.json','w')
    elif mode == 'zhidaotrain':
        f = open('/Users/maomin/programs/dureader_data/preprocessed/trainset/zhidao.train.json')
        fw = open('/Users/maomin/programs/MRC_Competition_Dureader-master/others/Dureader_2019/Dureader/data/extracted/trainset/zhidao.train.json','w')
    elif mode == 'searchdev':
        f = open('/Users/maomin/programs/dureader_data/preprocessed/devset/search.dev.json')
        fw = open('/Users/maomin/programs/MRC_Competition_Dureader-master/others/Dureader_2019/Dureader/data/extracted/devset/search.dev.json','w')
    elif mode == 'zhidaodev':
        f = open('/Users/maomin/programs/dureader_data/preprocessed/devset/zhidao.dev.json')
        fw = open('/Users/maomin/programs/MRC_Competition_Dureader-master/others/Dureader_2019/Dureader/data/extracted/devset/zhidao.dev.json','w')
    ...
    for idx, line in enumerate(f):
        ...
        try:
            ...
            line_ = json.dumps(sample, ensure_ascii=False, default=str)
            fw.write(line_ + '\n')
        except:
